...
REM====================================================================
SET ModFile001=URSS_TUniteAuSol.xml
SET ModFile002=URSS_TUniteDescriptor.xml
SET ModFile003=URSS_TWargameLabelModuleDescriptor.xml
SET ModFile004=URSS_TTransportableModuleDescriptor.xml
SET ModFile005=URSS_TWeaponManagerModuleDescriptor.xml
SET ModFile006=URSS_TTurretTwoAxisDescriptor.xml
SET ModFile007=URSS_TTurretInfanterieDescriptor.xml
SET ModFile008=URSS_TMountedWeaponDescriptor.xml
SET ModFile009=URSS_TModernWarfareDamageModuleDescriptor.xml
SET ModFile010=URSS_TAmmunition.xml
SET ModFile011=URSS_TDepictionTemplate.xml
SET ModFile012=URSS_TTypeUnitModuleDescriptor.xml
SET ModFile013=URSS_TUniteBehaviourDescriptor.xml
SET ModFile014=URSS_TBlindageProperties.xml
SET ModFile015=URSS_TMissileCarriageSubDepictionGenerator.xml
SET ModFile016=URSS_TMissileCarriageConnoisseur.xml
SET ModFile017=URSS_TTurretUnitDescriptor.xml
SET ModFile018=URSS_TMouvementHandlerAirplaneDescriptor.xml
SET ModFile019=URSS_TMissileCarriageWeaponInfo.xml
SET ModFile020=URSS_TActionDescriptorLaunchEffetOnSousMobile.xml
SET ModFile021=URSS_TCosmeticTurretOperatorDesc.xml
